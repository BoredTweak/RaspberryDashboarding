    ...
    try:
        for i, ticker in enumerate(tickers):
            try:
                ...
                # Enable to append h1 elements with data retrieved from quandl
				#graphs.append(html.H1(
                #    'Data retrieved for {}'.format(ticker),
                #    style={'marginTop': 20, 'marginBottom': 20}
                #))
                #graphs.append(html.H1(
                #    'Columns retrieved: {}'.format(list(df.columns.values)),
                #    style={'marginTop': 20, 'marginBottom': 20}
                #))
                #graphs.append(html.H1(
                #    'Dates retrieved: {}'.format(df['Date']),
                #    style={'marginTop': 20, 'marginBottom': 20}
                #))
                #graphs.append(html.H1(
                #    'Open retrieved: {}'.format(df['Open']),
                #    style={'marginTop': 20, 'marginBottom': 20}
                #))
